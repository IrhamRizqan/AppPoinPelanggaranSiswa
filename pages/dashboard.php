      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="#">
            ...
            <span class="nav-link-text ms-1">Admin Pages</span>
          </a>
        </li>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><a href="edit-data.php?id=<?php echo $data['id_siswa']?>"><button>Edit</button></a><a href="hapus-data.php?id=<?php echo $data['id_siswa']?>"><button>Hapus</button></a></td>
                  </tr>
                  </tbody>
                </table>
                <?php } ?>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <a href="javascript:void(0)" class="switch-trigger background-color">
          <div class="badge-colors my-2 text-start">
            <span class="badge filter bg-gradient-primary active" da
            ta-color="primary" onclick="sidebarColor(this)"></span>
