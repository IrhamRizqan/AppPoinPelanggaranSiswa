  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <center>
          <form action="proses-insert-siswa.php" method="post">
                  <input type="text" name="namaSiswa" id="" placeholder="Nama Siswa">
                  <input type="text" name="jurusanSiswa" id="" placeholder="Jurusan Siswa">
                  <input type="number" name="kelasSiswa" id="" placeholder="Kelas Siswa">
